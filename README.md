...
| ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| [![Screenshot of store homepage](./docs/img/shop-frontend.png)](./docs/img/shop-frontend.png) | [![Screenshot of checkout screen](./docs/img/shop-frontend-2.png)](./docs/img/shop-frontend-2.png) |
